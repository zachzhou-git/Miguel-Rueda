...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/Miguel-Rueda/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/Miguel-Rueda/https:/dataverse.harvard.edu/dataverse/mrueda";
          },
        ...
        section: 'Socials',
        handler: () => {
          window.open("/Miguel-Rueda/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/Miguel-Rueda/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
